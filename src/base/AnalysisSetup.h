...
struct AnalysisSetup {
 ...
 public:
  ...
  [[deprecated]]
  void AddTrackQvector(const QVectorTrack& conf) { track_qvectors_.emplace_back(conf); }
  [[deprecated]]
  void AddChannelQvector(const QVectorChannel& conf) { channel_qvectors_.emplace_back(conf ); }
